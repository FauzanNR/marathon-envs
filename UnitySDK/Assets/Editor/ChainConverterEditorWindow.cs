...
namespace Mujoco
{
    ...
    public class ChainConverterEditorWindow : EditorWindow
    {
        ...
        public static void ConvertArticulationBodyToMj()
        {
            ...
            {
                SwitchToMjBody(articulationBody);
            }
        }

        public static void SwitchToMjBody(ArticulationBody articulationBody)
        {

            Transform sceneTransform = articulationBody.transform.parent;
            Transform actuatorParent = new GameObject("actuators").transform;
            actuatorParent.parent = sceneTransform;
            ...
            else if (articulationBody.jointType == ArticulationJointType.SphericalJoint && articulationBody.dofCount < 3)
            {
        ...
        private static void SwitcColliderToMjGeom(Collider coll)
        {
            ...
            switch(coll)
            {
                ...
                case CapsuleCollider c:
                    ...
                    geom.Capsule.HalfHeight = (c.height - 2 * c.radius) / 2;
                    break;
                default:
